...
- **월 금액**: 7·8·9·10월 **각 40,000원** (cap). 실배포는 Lightsail **small**(2GB, $20≈₩27k)이고, cap은 여기에 환율·몰림 여유를 더한 천장. 한도 내 **실사용액만 자동 정산**이라 실비용은 small 기준 ~₩27k/월. (medium 상시 필요 시 다음 창구에 cap 상향 재신청)
