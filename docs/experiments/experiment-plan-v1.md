...
| **실행 결과** | ✅ **2026-09-07** — 126호출·폴백 0. [`l1-8-results.md`](l1-8-results.md) §3. **성공 기준 ①②(톤) 통과, ③(부호) 실패** — 이력 두 신호가 분량을 의도한 방향으로 못 바꿨고 **부호가 반대**다(음수 1~2/6). 룰 감쇠만 6/6 작동. ⚠️ 다섯 이력 블록이 **내용과 무관하게 +62~+93 으로 몰려** 있어, 모델이 이력 내용이 아니라 **이력 줄의 존재**에 반응했을 가능성이 있다 — 더미 이력 대조군 없이는 못 가른다 |
