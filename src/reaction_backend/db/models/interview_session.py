...
INTERVIEW_END_REASON_VALUES = ("completed", "turn_limit", "early_user")
...
class InterviewSession(Base, TimestampMixin):
    ...
    # 종료 시점의 모호함 지표 (필수 슬롯 중 미입력/저명확도 개수)
    ambiguity_final: Mapped[int | None] = mapped_column(Integer, nullable=True)
